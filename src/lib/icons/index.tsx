...
type ImageIconProps = React.SVGProps<SVGSVGElement>;
...
type EnhancerIconProps = React.SVGProps<SVGSVGElement>;

export const EnhancerIcon = (props: EnhancerIconProps) => {
  return (
    <svg
      width='18'
      height='18'
...
type RealtimeIconProps = React.SVGProps<SVGSVGElement>;

export const RealtimeIcon = (props: RealtimeIconProps) => {
  return (
    <svg
      width='18'
      height='18'
...
type PhotoProps = React.SVGProps<SVGSVGElement>;
...
export const GradientImage = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <div
      className='relative w-[42px] h-[42px] rounded-[10px] aspect-square shrink-0 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),inset_0_1px_5px_rgba(255,255,255,0.1)]'
      style={{
        background:
...
export const GradientVideo = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <path
          ...
          fill='#FFF'
        />
        <rect x='1' y='5.11182' width='16' height='15' rx='4' fill='#FFF' />
      </svg>
    </div>
  );
};

export const GradientRealtime = () => {
  return (
    <div
...
export const GradientMotion = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <div
      className='relative  aspect-square items-center justify-center rounded-[10px] inset-ring-[0.5px] inset-ring-white/10 block shrink-0 bg-[#1B1C1D] text-white'
      style={{ width: '42px', height: '42px' }}
    >
      <svg
        width='42'
...
export const Gradient3D = () => {
  return (
    <div
      className='relative flex aspect-square items-center justify-center rounded-[10px] inset-ring-[0.5px] inset-ring-white/10 shrink-0 bg-[#2f2f2f]'
      style={{ width: '42px', height: '42px' }}
    >
      <svg
        width='22'
    ...
    >
      ...
      >
        ...
        <path
          ...
          fill='#FFF'
        />
        <circle cx='16.5' cy='6.5' r='5.5' fill='#FFF' />
      </svg>
    </div>
  );
};

export const GradientRestyle = () => {
  return (
    <div
      className='relative aspect-square rounded-[10px] bg-[oklch(70%_0.1776_23.29)] inset-ring-[0.5px] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),inset_0_1px_5px_rgba(255,255,255,0.1)] inset-ring-black/10 block shrink-0'
      style={{ width: '42px', height: '42px' }}
    >
      <svg
        width='24'
      ...
      >
        <mask id='cutoutMask'>
          <rect x='1' y='5.11182' width='16' height='15' rx='4' fill='white' />
        ...
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          d='M22.263 7.174c-.626-.762-1.757-.873-2.52-.25l-1.226 1.004a1.002 1.002 0 00-.356.828v6.401c0 .375.167.73.458.964l1.214.998c.316.261.719.404 1.134.404a1.6 1.6 0 001.794-1.79l.012-7.598a1.6 1.6 0 00-.51-1.061z'
          fill='#FFF'
        />
        <rect
          x='1'
...
export const GradientTrain = () => {
  return (
    <svg
      ...
      viewBox='0 0 24 24'
      fill='none'
      className='dark:text-primary-0 text-[#c4c4c5] size-10.5 shrink-0'
      xmlns='http://www.w3.org/2000/svg'
    >
      <defs>
      ...
      <image
        xlinkHref='/train-icon-photo.webp'
        x='5'
        y='5'
        width='14'
        height='14'
...
export const GradientAsset = () => {
  return (
    ...
    >
      ...
      />
      <path
        d='M5.28147 36.2445C5.17675 35.6966 5.16776 34.9794 5.16699 33.907H41.8335C41.8327 34.9794 41.8238 35.6966 41.719 36.2445H5.28147Z'
        fill='black'
        fillOpacity='0.05'
      />
      <path
        d='M9.76801 38.5841H37.2321C38.8427 38.5841 39.648 38.5841 40.2631 38.2444C40.8043 37.9456 41.2442 37.4688 41.5199 36.8824C41.6093 36.6923 41.6731 36.4855 41.7188 36.2466H5.28125C5.32692 36.4855 5.3908 36.6923 5.48014 36.8824C5.75586 37.4688 6.1958 37.9456 6.73692 38.2444C7.35209 38.5841 8.1574 38.5841 9.76801 38.5841Z'
        fill='black'
        fillOpacity='0.1'
      />
    </svg>
